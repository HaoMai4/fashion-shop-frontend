...
import imgPoloBasicNam from '@/assets/products/polo-basic-nam.jpg';
import imgAoThunCoTronNam from '@/assets/products/ao-thun-co-tron-nam.jpg';
import imgQuanShortTheThaoNam from '@/assets/products/quan-short-the-thao-nam.jpg';
import imgSoMiOxfordTrangNam from '@/assets/products/so-mi-oxford-trang-nam.jpg';
import imgQuanDaiKakiNam from '@/assets/products/quan-dai-kaki-nam.jpg';
import imgAoTankTopGymNam from '@/assets/products/ao-tank-top-gym-nam.jpg';
import imgAoCroptopNuBasic from '@/assets/products/ao-croptop-nu-basic.jpg';
import imgVayLienCongSoNu from '@/assets/products/vay-lien-cong-so-nu.jpg';
import imgQuanLeggingTheThaoNu from '@/assets/products/quan-legging-the-thao-nu.jpg';
import imgAoHoodieOversizeUnisex from '@/assets/products/ao-hoodie-oversize-unisex.jpg';
import imgAoPoloNuSlimFit from '@/assets/products/ao-polo-nu-slim-fit.jpg';
import imgQuanJoggerTheThaoNam from '@/assets/products/quan-jogger-the-thao-nam.jpg';
import imgAoBraTheThaoNu from '@/assets/products/ao-bra-the-thao-nu.jpg';
import imgNonLuoiTraiUnisex from '@/assets/products/non-luoi-trai-unisex.jpg';
import imgTatTheThaoCaoCo from '@/assets/products/tat-the-thao-cao-co.jpg';
import imgAoThunNuOversize from '@/assets/products/ao-thun-nu-oversize.jpg';
import imgQuanJeanSlimFitNam from '@/assets/products/quan-jean-slim-fit-nam.jpg';
import imgBaloThoiTrangMatewear from '@/assets/products/balo-thoi-trang-matewear.jpg';
import imgSetDoTheThaoNu from '@/assets/products/set-do-the-thao-nu.jpg';
import imgBoxerBriefNam from '@/assets/products/boxer-brief-nam-3-chiec.jpg';
import imgAoKhoacGioUnisex from '@/assets/products/ao-khoac-gio-unisex.jpg';
import imgQuanShortKakiNu from '@/assets/products/quan-short-kaki-nu.jpg';
...
export const sanPhamData: SanPham[] = [
  {
    ...
    gia: 299000, giaGoc: 399000, hinhAnh: [imgPoloBasicNam], danhMucId: 1, danhMuc: 'Áo Polo', gioiTinh: 'nam',
  ...
  },
  {
    ...
    gia: 199000, hinhAnh: [imgAoThunCoTronNam], danhMucId: 2, danhMuc: 'Áo Thun', gioiTinh: 'nam',
  ...
  },
  {
    ...
    gia: 259000, giaGoc: 350000, hinhAnh: [imgQuanShortTheThaoNam], danhMucId: 5, danhMuc: 'Quần Short', gioiTinh: 'nam',
  ...
  },
  {
    ...
    gia: 449000, hinhAnh: [imgSoMiOxfordTrangNam], danhMucId: 3, danhMuc: 'Sơ Mi', gioiTinh: 'nam',
  ...
  },
  {
    ...
    gia: 399000, giaGoc: 499000, hinhAnh: [imgQuanDaiKakiNam], danhMucId: 4, danhMuc: 'Quần Dài', gioiTinh: 'nam',
  ...
  },
  {
    ...
    gia: 179000, hinhAnh: [imgAoTankTopGymNam], danhMucId: 6, danhMuc: 'Đồ Thể Thao', gioiTinh: 'nam',
  ...
  },
  {
    ...
    gia: 169000, hinhAnh: [imgAoCroptopNuBasic], danhMucId: 2, danhMuc: 'Áo Thun', gioiTinh: 'nu',
  ...
  },
  {
    ...
    gia: 549000, giaGoc: 699000, hinhAnh: [imgVayLienCongSoNu], danhMucId: 8, danhMuc: 'Váy', gioiTinh: 'nu',
  ...
  },
  {
    ...
    gia: 349000, hinhAnh: [imgQuanLeggingTheThaoNu], danhMucId: 6, danhMuc: 'Đồ Thể Thao', gioiTinh: 'nu',
  ...
  },
  {
    ...
    gia: 399000, hinhAnh: [imgAoHoodieOversizeUnisex], danhMucId: 9, danhMuc: 'Áo Khoác', gioiTinh: 'unisex',
  ...
  },
  {
    ...
    gia: 279000, hinhAnh: [imgAoPoloNuSlimFit], danhMucId: 1, danhMuc: 'Áo Polo', gioiTinh: 'nu',
  ...
  },
  {
    ...
    gia: 329000, giaGoc: 420000, hinhAnh: [imgQuanJoggerTheThaoNam], danhMucId: 6, danhMuc: 'Đồ Thể Thao', gioiTinh: 'nam',
  ...
  },
  {
    ...
    gia: 249000, hinhAnh: [imgAoBraTheThaoNu], danhMucId: 7, danhMuc: 'Đồ Lót', gioiTinh: 'nu',
  ...
  },
  {
    ...
    gia: 149000, hinhAnh: [imgNonLuoiTraiUnisex], danhMucId: 10, danhMuc: 'Phụ Kiện', gioiTinh: 'unisex',
  ...
  },
  {
    ...
    gia: 99000, hinhAnh: [imgTatTheThaoCaoCo], danhMucId: 10, danhMuc: 'Phụ Kiện', gioiTinh: 'unisex',
  ...
  },
  {
    ...
    gia: 229000, hinhAnh: [imgAoThunNuOversize], danhMucId: 2, danhMuc: 'Áo Thun', gioiTinh: 'nu',
  ...
  },
  {
    ...
    gia: 459000, giaGoc: 599000, hinhAnh: [imgQuanJeanSlimFitNam], danhMucId: 4, danhMuc: 'Quần Dài', gioiTinh: 'nam',
  ...
  },
  {
    ...
    gia: 499000, hinhAnh: [imgBaloThoiTrangMatewear], danhMucId: 10, danhMuc: 'Phụ Kiện', gioiTinh: 'unisex',
  ...
  },
  {
    ...
    gia: 549000, giaGoc: 699000, hinhAnh: [imgSetDoTheThaoNu], danhMucId: 6, danhMuc: 'Đồ Thể Thao', gioiTinh: 'nu',
  ...
  },
  {
    ...
    gia: 299000, hinhAnh: [imgBoxerBriefNam], danhMucId: 7, danhMuc: 'Đồ Lót', gioiTinh: 'nam',
  ...
  },
  {
    ...
    gia: 359000, hinhAnh: [imgAoKhoacGioUnisex], danhMucId: 9, danhMuc: 'Áo Khoác', gioiTinh: 'unisex',
  ...
  },
  {
    ...
    gia: 269000, hinhAnh: [imgQuanShortKakiNu], danhMucId: 5, danhMuc: 'Quần Short', gioiTinh: 'nu',
